...
echo "🚀 PIPELINE PERFORMANCE TEST: 10 Minute Multi-Step Load Test"
echo "============================================================="
...
while true; do
  ...
  if (( elapsed >= TEST_DURATION )); then
    echo "⏰ 10 minutes completed, stopping pipeline test..."
    break
  fi
...
echo "🎉 10-MINUTE PIPELINE PERFORMANCE TEST COMPLETED!"
echo "==============================================="
